# ErrorPage SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ErrorPageSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ErrorPageSDK(...) and ErrorPageSDK.test(...) become
#      ErrorPageSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "errorpage_sdk"
_SDK_CLASS = "ErrorPageSDK"
...
_ENTITIES = {
    "TechnologyDetection": "technology_detection",
}
