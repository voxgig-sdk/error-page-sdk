...
from errorpage_sdk.errorpage_types import (
    TechnologyDetection,
...
class TechnologyDetectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TechnologyDetectionEntity(self._client, opts)
    ...
    def data_get(self) -> TechnologyDetection:
    ...
    def match_get(self) -> TechnologyDetection:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TechnologyDetection]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TechnologyDetection().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
