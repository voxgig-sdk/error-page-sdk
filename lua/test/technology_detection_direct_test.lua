...
describe("TechnologyDetectionDirect", function()
  it("should direct-list-technology_detection", function()
    local setup = technology_detection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-technology_detection", setup.live and "live" or "unit")
