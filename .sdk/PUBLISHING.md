...
|---|---|---|
| `ts/` | @voxgig-sdk/error-page-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/error-page-sdk \
      --repository voxgig-sdk/error-page-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/error-page-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/error-page-sdk --id=<id>` removes one.
