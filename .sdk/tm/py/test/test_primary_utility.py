...
_runner = makeRunner(TEST_JSON_FILE, ErrorPageSDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = ErrorPageSpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ErrorPageSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ErrorPageSDK.test(None, setup.get('a') or {})
