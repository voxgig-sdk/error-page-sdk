...
from projectname_sdk import ErrorPageSDK
from projectname_sdk.core.spec import ErrorPageSpec
from projectname_sdk.core.result import ErrorPageResult
from projectname_sdk.core.response import ErrorPageResponse
from projectname_sdk.core.operation import ErrorPageOperation
from projectname_sdk.core.error import ErrorPageError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ErrorPageBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ErrorPageError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ErrorPageSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ErrorPageSDK.test(None, None)
        ...
        class TestInitFeature(ErrorPageBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ErrorPageBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ErrorPageSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ErrorPageSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ErrorPageSDK.test(None, setup_opts)
