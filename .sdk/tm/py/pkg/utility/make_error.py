# ErrorPage SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, ErrorPageError):
        errmsg = err.msg
    ...
    msg = "ErrorPageSDK: " + opname + ": " + errmsg
    ...
    sdk_err = ErrorPageError("", msg, ctx)
