...
class ErrorPageFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ErrorPageSDK/1.0)';
    ...
    public static function call(ErrorPageContext $ctx, string $fullurl, array $fetchdef): array
    {
