...
class ErrorPageGraphql
{
    ...
    // equivalent.
    public static function body(ErrorPageContext $ctx): mixed
    {
    ...
    public static function errors(ErrorPageContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
