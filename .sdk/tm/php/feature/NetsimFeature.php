...
class ErrorPageNetsimFeature extends ErrorPageBaseFeature
{
    ...
    private function _simulate(ErrorPageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ErrorPageContext $ctx, array $applied): void
    {
        $client = $this->client;
