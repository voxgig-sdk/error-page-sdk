...
class ErrorPageProxyFeature extends ErrorPageBaseFeature
{
    ...
    public function init(ErrorPageContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ErrorPageContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
