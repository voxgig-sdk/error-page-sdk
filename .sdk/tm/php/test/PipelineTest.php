...
{
    private static function utility(): ErrorPageUtility
    {
        return new ErrorPageUtility();
    }
    ...
    private static function ctx(array $over = []): ErrorPageContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ErrorPageContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ErrorPageOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ErrorPageError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ErrorPageOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ErrorPageMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ErrorPageOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ErrorPageMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ErrorPageOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ErrorPageMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ErrorPageSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ErrorPageMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ErrorPageResponse([]),
            'result' => new ErrorPageResult([]),
        ]);
        [, $err] = ErrorPageMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ErrorPageSpec([]),
            'response' => null,
            'result' => new ErrorPageResult([]),
        ]);
        [, $err] = ErrorPageMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ErrorPageSpec(['step' => 's']),
            'response' => new ErrorPageResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ErrorPageResult([]),
        ]);
        [, $err] = ErrorPageMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ErrorPageSpec(['step' => 's']),
            'response' => new ErrorPageResponse(self::resp(200, ['v' => 1])),
            'result' => new ErrorPageResult([]),
        ]);
        [, $err] = ErrorPageMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ErrorPageSpec(['step' => 's']),
            'response' => new ErrorPageResponse(self::resp(200, ['v' => 2])),
            'result' => new ErrorPageResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ErrorPageMakeResponse::call($ctx);
    ...
    {
        $preset = new ErrorPageResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ErrorPageSpec([]),
            'response' => new ErrorPageResponse([]),
            'result' => new ErrorPageResult([]),
        ...
        [$got, $err] = ErrorPageMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ErrorPageResult([])]);
        [, $err] = ErrorPageMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ErrorPageSpec([]), 'result' => null]);
        [, $err] = ErrorPageMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ErrorPageSpec(['step' => 's']),
            'result' => new ErrorPageResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ErrorPageOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ErrorPageMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ErrorPageSpec(['step' => 's']),
            'result' => new ErrorPageResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ErrorPageOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ErrorPageMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ErrorPageResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ErrorPageSpec([]),
            'result' => new ErrorPageResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ErrorPageMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ErrorPageMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ErrorPageError('boom', 'boom');
        $utility->fetcher = function (ErrorPageContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ErrorPageSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ErrorPageMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ErrorPageContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ErrorPageMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ErrorPageResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ErrorPageContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ErrorPageSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ErrorPageMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ErrorPageResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ErrorPageSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ErrorPageMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ErrorPageMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ErrorPageMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ErrorPageResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ErrorPageDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ErrorPageResult(['ok' => false])]);
        $this->expectException(ErrorPageError::class);
        ErrorPageDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ErrorPageResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ErrorPageMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ErrorPageMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ErrorPageBaseFeature();
        $b = new ErrorPageBaseFeature();
        ErrorPageFeatureAdd::call($ctx, $a);
        ErrorPageFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ErrorPageBaseFeature
    {
        $f = new ErrorPageBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ErrorPageFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?ErrorPageSpec $spec): ErrorPageContext
    {
    ...
    private static function auth_bags(): ErrorPageSpec
    {
        return new ErrorPageSpec(['headers' => [], 'query' => []]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ErrorPagePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ErrorPageResponse(['headers' => null]),
            'result' => new ErrorPageResult([]),
        ]);
        ErrorPageResultHeaders::call($ctx);
