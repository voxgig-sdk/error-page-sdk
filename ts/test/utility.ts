...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ERRORPAGE_TEST_LIVE ||
    'TRUE' === process.env.ERRORPAGE_TEST_OVERRIDE
  ) {
  ...
  m.ERRORPAGE_TEST_EXPLAIN = process.env.ERRORPAGE_TEST_EXPLAIN || m.ERRORPAGE_TEST_EXPLAIN
