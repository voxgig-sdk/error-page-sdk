...
(0, node_test_1.describe)('TechnologyDetectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ErrorPageSDK({
    ...
    (0, node_test_1.test)('direct-list-technology_detection', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-technology_detection', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ERROR_PAGE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ErrorPageSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ERROR_PAGE_TEST_TECHNOLOGY_DETECTION_ENTID'];
    ...
    const client = new __1.ErrorPageSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TechnologyDetectionDirect.test.js.map