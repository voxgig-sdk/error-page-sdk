...
function envOverride(m) {
    if ('TRUE' === process.env.ERROR_PAGE_TEST_LIVE ||
        'TRUE' === process.env.ERROR_PAGE_TEST_OVERRIDE) {
    ...
    m.ERROR_PAGE_TEST_EXPLAIN = process.env.ERROR_PAGE_TEST_EXPLAIN || m.ERROR_PAGE_TEST_EXPLAIN;
    return m;
}
