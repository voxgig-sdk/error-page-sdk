...
func registerSDKWords(r *eng.Registry, client *sdk.ErrorPageSDK) {
...
func runOp(client *sdk.ErrorPageSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
