// Command ErrorPage-cli is a CLI + REPL for the ErrorPage SDK,
...
const prompt = "error-page"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "technology_detection"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ERROR_PAGE_APIKEY (api key), ERROR_PAGE_BASE (base url override)")
