...
// ErrorPage SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ErrorPageTestFeature extends ErrorPageBaseFeature
{
    ...
    public function init(ErrorPageContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ErrorPageContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ErrorPageParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ErrorPageContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ErrorPageContext $ctx, $op, $args): array
    {
