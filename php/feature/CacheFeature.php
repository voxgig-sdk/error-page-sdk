...
class ErrorPageCacheFeature extends ErrorPageBaseFeature
{
    ...
    private function _through(ErrorPageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
