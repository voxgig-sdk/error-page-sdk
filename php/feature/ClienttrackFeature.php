...
// ErrorPage SDK clienttrack feature
...
class ErrorPageClienttrackFeature extends ErrorPageBaseFeature
{
    ...
    public function PostConstruct(ErrorPageContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ErrorPage-SDK';
