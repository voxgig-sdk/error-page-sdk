...
class ErrorPageTimeoutFeature extends ErrorPageBaseFeature
{
    ...
    private function _with_timeout(ErrorPageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ErrorPageContext $_ctx, float $ms): void
    {
        $client = $this->client;
