...
// ErrorPage SDK streaming feature
...
class ErrorPageStreamingFeature extends ErrorPageBaseFeature
{
    ...
    private function _iterate(ErrorPageResult $result): \Generator
    {
    ...
    private function _streamable(ErrorPageContext $ctx): bool
    {
