...
class ErrorPageRbacFeature extends ErrorPageBaseFeature
{
    ...
    private function _required(ErrorPageContext $ctx): ?string
    {
    ...
    private function _reject(ErrorPageContext $ctx, string $required): void
    {
    ...
    private function _track(ErrorPageContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
