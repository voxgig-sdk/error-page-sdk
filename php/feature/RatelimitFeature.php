...
// ErrorPage SDK ratelimit feature
...
class ErrorPageRatelimitFeature extends ErrorPageBaseFeature
{
    ...
    private function _acquire(ErrorPageContext $ctx): void
    {
    ...
    private function _track(ErrorPageContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
