...
// ErrorPage SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ErrorPageTransformResponse
{
    public static function call(ErrorPageContext $ctx): mixed
    {
        ...
        $transform = ErrorPageHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
