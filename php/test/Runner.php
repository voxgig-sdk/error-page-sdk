...
class ErrorPageTestRunner
{
    ...
    {
        $live = self::getenv('ERROR_PAGE_TEST_LIVE');
        $override = self::getenv('ERROR_PAGE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ERROR_PAGE_TEST_EXPLAIN');
...
class_alias('ErrorPageTestRunner', 'Runner');
class_alias('ErrorPageHelpers', 'Helpers');
