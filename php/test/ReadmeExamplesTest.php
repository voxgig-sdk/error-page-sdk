...
// ErrorPage SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ErrorPageSDK::test)
...
{
    private const SDK_CLASS = 'ErrorPageSDK';
    ...
    private const SDK_BASE = 'errorpage_sdk';
